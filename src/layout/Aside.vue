...
import { useApproximateDate } from "@/utils/hooks";
    ...
    <div class="base-box-weaken">
      ...
      ">
        ...
        <t-row style="max-height: 84vh; overflow-y: auto">
            <div class="aside-activity-list" :style="store.state.currentActivity.id === item.id
                ? 'background-color: #343538'
                : ''
                " v-for="item in activityList" :key="item.id" @click="getActivityDetail(item.id)">
                <t-row>
